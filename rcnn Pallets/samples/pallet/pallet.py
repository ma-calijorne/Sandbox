...
def train(model):
    ...
    dataset_train.load_pallet(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = PalletDataset()
    dataset_val.load_pallet(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/pallet/dataset/",
                        help='Directory of the Pallet dataset')
